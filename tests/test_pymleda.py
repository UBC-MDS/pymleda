...
def test_autoimpute_na_1(input_value):
    ...
    assert_frame_equal(pymleda.autoimpute_na(toy_df_1), input_value)


def test_autoimpute_na_2(input_value):
    """Test that the output dataframe of the pymleda.autoimpute_na() function
    with some missing values is equal to the model dataframe"""
    assert_frame_equal(pymleda.autoimpute_na(toy_df_2), input_value)